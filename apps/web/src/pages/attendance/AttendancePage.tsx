  ...
  return (
    <>
      ...
      <div className="toolbar card">
        ...
        <input className="input mono" placeholder="Class (e.g. 10)" value={classSlug} onChange={(e) => setClassSlug(e.target.value)} style={{ maxWidth: 140 }} />
        <input className="input mono" placeholder="Section (e.g. A)" value={section} onChange={(e) => setSection(e.target.value)} style={{ maxWidth: 120 }} />
          ...
          <table className="data-table">
            ...
            <tbody>
              ...
              {!isLoading && data?.rows.length === 0 && (
                <tr><td colSpan={6} style={{ padding: 32, textAlign: "center", color: "var(--ink-40)" }}>No students in this section</td></tr>
              )}
              {data?.rows.map((r) => (
                <tr key={r.srNumber}>
